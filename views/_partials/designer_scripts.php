<?php
/**
 * ezdoc/views/_partials/designer_scripts.php — main JS block for designer view.
 *
 * Extracted dari `views/document/designer.php` (v1.0-prep line target refactor).
 * Contains full editor JavaScript: config bootstrap, TinyMCE init, floating
 * elements, TTD placeholder, materai upload, table designer, etc.
 *
 * Expected in-scope vars (from parent designer.php):
 *   @var array|null           $template            Template row (edit mode) OR null
 *   @var string               $action              'list' | 'edit' | 'create'
 *   @var int                  $author_id           Current user ID
 *   @var array<string>        $author_role_array   Current user role list
 *
 * Include pattern from designer.php:
