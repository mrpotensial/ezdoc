                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            <a class="font-medium hover:underline"
                               ...
                               href="<?= htmlspecialchars($baseUrl . '/document/view?uuid=' . urlencode($doc->getUuid()), ENT_QUOTES, 'UTF-8') ?>">
                        ...
                        <td class="px-4 py-3 text-right">
                            <a class="inline-flex items-center rounded-md border border-gray-300 bg-white px-2.5 py-1.5 text-xs font-medium text-gray-700 shadow-sm hover:bg-gray-50"
                               href="<?= htmlspecialchars($baseUrl . '/document/print?uuid=' . urlencode($doc->getUuid()), ENT_QUOTES, 'UTF-8') ?>">
                                Print
                            </a>
